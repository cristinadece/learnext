...
test_ids = open("./svm-features/Pisa-test-ids")
trajectories = open("./input/Trajectories-PISA.tsv", 'r')
pois_info = open("./input/Pisa-PoIs", 'r')
categ_pois = open("./input/Pisa-Cats", 'r')
where_next_training = open("./where-next/where-next-PI-training", 'w')
where_next_test_validation = open("./where-next/where-next-PI-test-validation", 'w')
where_next_test = open("./where-next/where-next-PI-test", 'w')
