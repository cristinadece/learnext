...
training_ids = open("./svm-features/Firenze-training-ids", 'w')
test_ids = open("./svm-features/Firenze-test-ids", 'w')
training_file = open("./svm-features/Firenze-training-all-3neg-bull", 'w')
test_file = open("./svm-features/Firenze-test-all-3neg-bull", 'w')
...
#    compute_session_features(user_1, session_1)
    ...
    for user in users.itervalues():
        for session in user.get_sessions():
            ...
            #print p_f
            s_fv = s_f.values()
            current_features = s_f + p_f.values()
