...
if __name__ == '__main__':
    ...
    training_file = open("./svm-features/Firenze-training-all-k-"+str(k), 'w')
    test_file = open("./svm-features/Firenze-test-all-k-"+str(k), 'w')
    ...
    session_ids = [ s.get_id() for s in sessions.itervalues() if len(s.get_pois())>k]
