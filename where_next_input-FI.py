...
where_next_training = open("./where-next/where-next-FI-training", 'w')
where_next_test_validation = open("./where-next/where-next-FI-test-validation", 'w')
where_next_test = open("./where-next/where-next-FI-test", 'w')
