...
poi_distrib_file = open("./input/Rome-poi-distribution", 'w')
...
test_file = open("./svm-features/Rome-test-all-3neg", "r")
test_file_rare = open("./svm-features/Rome-test-all-3neg-rare", "w")
test_file_freq = open("./svm-features/Rome-test-all-3neg-freq", "w")
