...
training_ids = open("./svm-features/Rome-training-ids", 'w')
test_ids = open("./svm-features/Rome-test-ids", 'w')
training_file = open("./svm-features/Rome-training-all-3neg", 'w')
test_file = open("./svm-features/Rome-test-all-3neg", 'w')
