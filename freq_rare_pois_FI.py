...
pois_info = open("./input/Firenze-PoIs", 'r')
...
poi_distrib_file = open("./input/Firenze-poi-distribution", 'w')
...
test_file = open("./svm-features/Firenze-test-all-3neg", "r")
test_file_rare = open("./svm-features/Firenze-test-all-3neg-rare", "w")
test_file_freq = open("./svm-features/Firenze-test-all-3neg-freq", "w")
